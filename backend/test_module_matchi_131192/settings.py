"""
Django settings for test_module_matchi_131192 project.
...
ROOT_URLCONF = 'test_module_matchi_131192.urls'
...
WSGI_APPLICATION = 'test_module_matchi_131192.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_module_matchi_131192 API",
    "DESCRIPTION": "API documentation for test_module_matchi_131192 App",
    "VERSION": "v1",
}
